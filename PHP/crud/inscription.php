...
if(isset($_POST['pseudo']) && isset($_POST['mdp']) && isset($_POST['nom']) && isset($_POST['prenom']) && isset($_POST['email']) && isset($_POST['sexe']) && isset($_POST['ville']) && isset($_POST['cp']) && isset($_POST['adresse']))
{
  ...
  {
    $content = '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, la taille du pseudo est invalide<br />En effet, le pseudo doit avoir entre 4 et 20 caractères inclus</div>';
    $erreur = true; // si l'on rentre dans cette condition alors il y a une erreur
  }

  if(iconv_strlen($nom)<4 || iconv_strlen($nom)>20)
  {
    $content .= '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, veuillez entrer un nom entre 4 et 20 caractères inclus</div>';
    $erreur = true; // si l'on rentre dans cette condition alors il y a une erreur
  }

  if(iconv_strlen($prenom)<4 || iconv_strlen($prenom)>20)
  {
    $content .= '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, veuillez entrer un prénom entre 4 et 20 caractères inclus</div>';
    $erreur = true; // si l'on rentre dans cette condition alors il y a une erreur
  }

  // contrôle des caractères dans le pseudo (autorisées: a-z A-Z 0-9 _ - .)
  $verif_caracteres_pseudo = preg_match('#^[a-zA-Z0-9._-]+$#', $pseudo);
  $verif_caracteres_nom = preg_match('#^[a-zA-Z0-9._-]+$#', $nom);
  $verif_caracteres_prenom = preg_match('#^[a-zA-Z0-9._-]+$#', $prenom);
  /*
  ...
  */
  ...
  if(!$verif_caracteres_pseudo && !empty($pseudo))
  {
    // on rentre dans cette condition si $verif_caracteres contient 0 donc s'il y a des caracteres non autorisés
    $content = '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, caractères non autorisés dans le pseudo<br />Caractères autorisés: a-z et 0-9</div>';
    $erreur = true;
  }

  if(!$verif_caracteres_nom && !empty($nom))
  {
    // on rentre dans cette condition si $verif_caracteres contient 0 donc s'il y a des caracteres non autorisés
    $content = '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, caractères non autorisés dans le nom<br />Caractères autorisés: a-z et 0-9</div>';
    $erreur = true;
  }

  if(!$verif_caracteres_prenom && !empty($prenom))
  {
    // on rentre dans cette condition si $verif_caracteres contient 0 donc s'il y a des caracteres non autorisés
    $content = '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, caractères non autorisés dans le prenom<br />Caractères autorisés: a-z et 0-9</div>';
    $erreur = true;
  }
  ...
  {
    // on rentre dans cette condition si $verif_caracteres contient 0 donc s'il y a des caracteres non autorisés
    $content .= '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, le format de l\'email n\'est pas valide</div>';
    $erreur = true;
  }
  ...
  if($dispo_pseudo->rowCount()>0)
  {
    ...
    $content .= '<div class="alert alert-danger" role="alert" style="margin-top: 20px;">Attention, le pseudo est déjà pris, veuillez changer votre saisie</div>';
    $erreur = true;
  ...
  if($erreur !== true) // si $erreur est différent de true lors les contrôles préalables sont ok
  {
    ...
    $enregistrement = $pdo->prepare("INSERT INTO membre(pseudo, mdp, nom, prenom, email, civilite, ville, code_postal, adresse, statut) VALUES(:pseudo, :mdp, :nom, :prenom, :email, :civilite, :ville, :cp, :adresse, 0)");
...
<section>
    <div class="container">
      ...
      <div class="starter-template">
        ...
        <?= $content; // cette balise php inclus un echo (equivalent à la ligne du dessus) ?>
      </div>
        ...
        <div class="col-sm-5 col-sm-offset-3">
          <form class="form-horizontal" method="post" action="">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="password" class="form-control" name="mdp" id="mdp" placeholder="Password" value="">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="email" id="email" placeholder="example@mail.com" value="">
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="ville" id="ville" placeholder="Ville" value="">
              </div>
            </div>
            <div class="form-group">
              <label for="cp" class="col-sm-4 control-label">Code Postal</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" name="cp" id="cp" placeholder="CP" value="">
              </div>
            </div>
            <div class="form-group">
              <label for="adresse" class="col-sm-4 control-label">Adresse</label>
              <div class="col-sm-8">
               <textarea class="form-control" name="adresse" id="adresse" cols="41" rows="4" style="resize: none;"></textarea>
              </div>
            </div>
            <div class="form-group">
