...
<html lang="fr">
  ...
  <?php
    ...
    // avez vous pensé au cas d'erreur, exemple si je viens sur cette page sans valider le formulaire, y-a t'il des erreurs php affichées. Si c'est le cas -> il faut corriger.
    if(isset($_POST['expediteur']) && isset($_POST['sujet']) && isset($_POST['message']))
    {
        ...
        echo "Votre sujet est: " . $sujet . "<br />";
        echo "Votre message est: " . $message . "<br />";

        // envoi d'un mail via la fonction prédéfinie mail()
        $expediteur = "From: $expediteur \n"; // \n est un retour à la ligne dans un fichier. /!\ il doit être dans des "" pour être bien interprété.
        ...
        mail('qlefevre78@gmail.com', $sujet, $message, $expediteur);
    }
  ...
  ?>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1 class="glyphicon glyphicon-envelope">Contact</h1>
      </div>
